  ...
  return (
    <div className="max-w-[210mm] min-h-[297mm] mx-auto my-8 px-[20mm] py-[25mm] bg-white shadow-lg leading-relaxed print:max-w-none print:m-0 print:shadow-none print:page-break-inside-avoid">
      ...
      <div className="mt-8">
        ...
        <TechStackSection
          category="스타일링"
          technologies="Tailwind CSS, CSS Modules, SCSS"
        />

        <TechStackSection category="빌드 도구" technologies="Vite, Webpack" />
      ...
      <Heading2>추가 프로젝트 (부트캠프)</Heading2>
...
export default ResumeWithCareer;
